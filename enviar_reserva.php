...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'residencial.lamarea@sapo.cv' =>
            ['#subject#' => 'Reservation Form Residencial La Marea',
                '#greeting#' => "Thanks $name, your booking request was received!"]

            $email =>
            ['#subject#' => 'La Marea Reservation Request',
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
            ...
            $image_logo = $message->embed(Swift_Image::fromPath('img/santiago/logote.png'));
...
center">Reservation Form La Marea</h1>
</td>
</tr>
<tr>
